...
We've used the [plone training documentation][volto-addon-basics] to do this, 
starting with a new repository to host the hero code. 

We then ran the addon creation wizzard, like this:
...
[volto-addon-basics]: https://training.plone.org/voltoaddons/01-addon-basics.html